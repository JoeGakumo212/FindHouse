...
const CreateList = () => {
  ...
  const createdUnit = async () => {
    const tokenFromCookie = cookies.access_token;
    try {
      const createUnitResponse = await axios.get(
                ...
                <form>
                      ...
                      <div className="col-lg-6 col-xl-6">
                        <div className="my_profile_setting_input ui_kit_select_search form-group">
                          ...
                          >
                            ...
                            <option data-tokens="Other">
                              % of Total Collected Rent
                            </option>
                          </select>
                        </div>
                      </div>
                  ...
                  <div className="my_dashboard_review mb-3">
                    <div className="row">
                      ...
                      <div className="col-lg-6 col-xl-6">
                        <div className="my_profile_setting_input ui_kit_select_search form-group">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setagent_commission_type(e.target.value)
                            }
                          >
                            <option value="" disabled selected>
                              Extra Charge Name
                      ...
                      <div className="col-lg-6 col-xs-6">
                        <div className="my_profile_setting_input form-group">
                          <label htmlFor="extra_charge_value ">
                            Extra Charge Value
                          </label>
                          <div className="input-group">
                            <input
                      ...
                      <div className="col-lg-6 col-xl-6">
                        <div className="my_profile_setting_input ui_kit_select_search form-group">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setextra_charge_type(e.target.value)
                            }
                          >
                            <option value="" disabled selected>
                              Extra Charge Type
                      ...
                      <div className="col-lg-6 col-xl-6">
                        <div className="my_profile_setting_input ui_kit_select_search form-group">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setextra_charge_frequency(e.target.value)
                            }
                          >
                            <option value="" disabled selected>
                              Frequency
                            ...
                            <option data-tokens="periodtoperiod">
                              Period to Period
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="col-lg-4 ">
                        <div className="my_profile_setting_input form-group">
                          ...
                          <input
                            ...
                            onChange={({ target }) =>
                              setutility_unit_cost(target?.value)
                            }
                          />
                        </div>
                      </div>
