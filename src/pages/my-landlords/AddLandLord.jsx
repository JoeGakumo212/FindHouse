          ...
          <div className="col-lg-12">
            <div className=" row  bg-success rounded-top text-light p-2 d-flex align-items-center justify-content-between">
              <div className="col-lg-8">
                {' '}
                <h2 className='text-light'>Landlord Management</h2>
              </div>
              <div className="col-lg-4 float-end">
                <div className="my_profile_setting_input">
                  <button className="btn btn1 float-start text-light" onClick={handleBack}>
                    Back to Landlords Data
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="favorite_item_list">
                <div className="container">
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-xl-6">
                      <div className="my_profile_setting_input form-group">
                        <label htmlFor="formGroupExampleInput15">
                          ID Number
                        </label>
                        <input
                          type="number"
                    ...
                    <div className="col-lg-6 col-xl-6">
                      <div className="my_profile_setting_input form-group">
                        ...
                        <input
                          ...
                          onChange={({ target }) =>
                            setResidentialAddress(target?.value)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-lg-6 col-xl-6">
                      <div className="my_profile_setting_input form-group">
                        <label htmlFor="formGroupExampleInput17">
                          Password
                        </label>
                        <input
                          type="password"
