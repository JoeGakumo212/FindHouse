...
const AddLease = () => {
  ...
  const largeLimit = new Big('999999999999999999999999999999999999');
                        ...
                        <div className="Extra-Charge-section">
                          <div className="row">
                            ...
                            <div className="col-lg-3 col-xl-0">
                              <div className="my_profile_setting_input form-group">
                                <label htmlFor="Exchange Charge Type">
                                  Extra Charge Type
                                </label>
                                <select
                              ...
                              <div className="col-lg-6 col-xl-0">
                                <div className="my_profile_setting_input form-group">
                                  ...
                                  <select
                                    ...
                                    className="selectpicker form-select"
                                  >
                                    {supportData.payment_methods.map(
                                      (paymentMethod) => (
                                        <option
                                ...
                                <div className="col-lg-12">
                                  <div className="my_profile_setting_input form-group">
                                    ...
                                    <div className="form-check">
                                      ...
                                      >
                                        Next Period Billing (When billing,
                                        invoice period is set as next month.)
                                      </label>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="col-lg-12">
                                  <div className="my_profile_setting_input form-group">
                                    <div className="form-check">
                                      ...
                                      >
                                        Waive Penalty (For this lease, do not
                                        charge penalties.)
                                      </label>
                                    </div>
                                  </div>
                                ...
                                <div className="col-lg-12">
                                  <div className="my_profile_setting_input form-group">
                                    <div className="form-check">
                                      ...
                                      >
                                        Skip Starting Period (For this lease, do
                                        not bill the first period.)
                                      </label>
                                    </div>
                                  </div>
                                </div>
