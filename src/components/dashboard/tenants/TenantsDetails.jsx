          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="my_profile_setting_input">
                <button className="btn btn2 float-start" onClick={handleNext}>
                  Next
                </button>
              </div>
            </div>
      ...
      {currentSection === 2 && (
        <div className="profile-section2 mt-3">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-xl-0">
              <div className="my_profile_setting_input form-group">
                <label htmlFor="nextOfKinRelation">Next of Kin Relation</label>
                <input
                  type="text"
                  className="form-control"
            ...
            <div className="col-lg-4 col-xl-0">
              <div className="my_profile_setting_input form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEmergency_contact_postal_address(e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div className="my_profile_setting_input form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEmergency_contact_physical_address(e.target.value)
                  }
                />
              </div>
            </div>
