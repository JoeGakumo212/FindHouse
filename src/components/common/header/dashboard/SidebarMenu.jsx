      ...
      <ul className="sidebar-menu">
        ...
        <li className="title">
          ...
          <ul>
            ...
            <li
              className={`treeview ${
                isSinglePageActive("/tenants", route.pathname)
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`treeview ${
                isSinglePageActive("/Leases", route.pathname)
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`treeview ${
                isSinglePageActive("/Payments", route.pathname)
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`treeview ${
                isSinglePageActive("/Vacants", route.pathname)
                  ? "active"
                  : ""
              }`}
            >
